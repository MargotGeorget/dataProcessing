...
GEORGET Margot
Fichier 12
Ce fichier contient des test de la fonction mediane_liste_FR_etrangers
"""
...
print("Médiane de la liste:", mediane_liste_FR_etrangers(lis_FR_etrangers))
...
lis_FR_etrangers.append(f)
print("\nTest2:","\nTest sur la liste (3 éléments, maximum au début, minimum au milieu:")
tri_croissant_liste_FR_etrangers(lis_FR_etrangers)
print("Médiane de la liste:", mediane_liste_FR_etrangers(lis_FR_etrangers))
...
f = FR_etrangers("A", 0 , 345, 1.2)
lis_FR_etrangers.append(f)
print("\nTest3:","\nTest sur la liste avec plusieurs doublons:")
tri_croissant_liste_FR_etrangers(lis_FR_etrangers)
print("Médiane de la liste:", mediane_liste_FR_etrangers(lis_FR_etrangers))
...
print("Médiane de la liste:", mediane_liste_FR_etrangers(FR_etrangers))
