...
GEORGET Margot
Fichier 17
Fichier de test de la fonction plus_petit_indice_presence contenu dans le fichier
...
print("La valeur 67 est presente à l'indice :",
      plus_petit_indice_presence (67,lis_FR_etrangers))
print("La valeur 82 est presente à l'indice :",
      plus_petit_indice_presence (82,lis_FR_etrangers))
...
print("La valeur 7921 est presente à l'indice :",
      plus_petit_indice_presence (7921,lis_FR_etrangers))
...
print("La valeur 6143 est presente à l'indice :",
      plus_petit_indice_presence (6143,lis_FR_etrangers))
print("La valeur 118331 est presente à l'indice :",
      plus_petit_indice_presence (118331,lis_FR_etrangers))
...
print("La valeur 207 est presente à l'indice :",
      plus_petit_indice_presence (207,lis_FR_etrangers))
print("La valeur 8922 est presente à l'indice :",
      plus_petit_indice_presence (8922,lis_FR_etrangers))
