...
GEORGET Margot
Fichier 10
Ce fichier contient des tests de la fonction ecart_type_liste_FR_etrangers
"""
...
print("Ecart-type de la liste:",
      ecart_type_liste_FR_etrangers (lis_FR_etrangers))
...
print("Ecart type de la liste:",
      ecart_type_liste_FR_etrangers (FR_etrangers))
