...
GEORGET Margot
Fichier 9
Ce fichier contient des tests de la fonctions moyenne_liste_FR_etrangers
"""
...
print("Moyenne de la liste:",
      moyenne_liste_FR_etrangers (lis_FR_etrangers) )
...
print("Moyenne de la liste:",
      moyenne_liste_FR_etrangers (FR_etrangers) )
