...
GEORGET Margot
Fichier 7
Fichier de test de la fonction valeur_min_liste_FR_etrangers (fichier6)
"""
...
print("Valeur minimale de la liste:",
      valeur_min_liste_FR_etrangers (lis_FR_etrangers) )

#TEST 2 : 
lis_FR_etrangers = []
f = FR_etrangers("A", 100 , 345, 1.2)
lis_FR_etrangers.append(f)
f = FR_etrangers("A", 20 , 345, 1.2)
lis_FR_etrangers.append(f)
f = FR_etrangers("A", 50 , 345, 1.2)
lis_FR_etrangers.append(f)
print("\nTest2:","\nTest sur la liste (3 éléments, minimum au milieu:")
affiche_liste_FR_etrangers_annee1(lis_FR_etrangers)
print("Valeur minimale de la liste:",
      valeur_min_liste_FR_etrangers (lis_FR_etrangers) )
...
lis_FR_etrangers.append(f)
print("\nTest3:","\nTest sur la liste (minimum à la fin):")
affiche_liste_FR_etrangers_annee1(lis_FR_etrangers)
print("Valeur minimale de la liste:",
      valeur_min_liste_FR_etrangers (lis_FR_etrangers) )
...
print("Valeur minimale de la liste:",
      valeur_min_liste_FR_etrangers (FR_etrangers) )
